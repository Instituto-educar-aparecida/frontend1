      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          {stats.map((s) => (
            <div
              key={s.label}
              className="bg-secondary rounded-2xl p-5 border border-white/5"
            >
            ...
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-xs text-gray-400">
                  Engajamento semanal de novos usuários
                </p>
              </div>
              <div className="flex gap-2">
                {["7D", "30D", "12M"].map((p) => (
                  <button
                    key={p}
                    className="text-xs px-3 py-1 rounded-lg bg-white/5 text-gray-400 hover:bg-violet-600/20 hover:text-violet-400 transition-all"
                  >
                    {p}
                  </button>
                ))}
        ...
        <div className="bg-secondary rounded-2xl p-5 border border-white/5">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-xs text-gray-400">
                Monitoramento em tempo real de novos registros.
              </p>
            </div>
            <input
              placeholder="Filtrar..."
          ...
          <div className="flex items-center justify-between mt-4 pt-4 border-t border-white/5">
            <span className="text-xs text-gray-500">
              Exibindo 3 de 12.482 registros
            </span>
            <div className="flex gap-2">
              <button className="text-xs px-3 py-1 rounded-lg bg-white/5 text-gray-400 hover:bg-violet-600/20 transition-all">
                ←
              </button>
              <button className="text-xs px-3 py-1 rounded-lg bg-violet-600 text-white">
                1
              </button>
              <button className="text-xs px-3 py-1 rounded-lg bg-white/5 text-gray-400 hover:bg-violet-600/20 transition-all">
                →
