    ...
    <div className="overflow-y-auto h-[calc(100vh-70px)] px-8 py-6 bg-primary">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-400 mt-1">Analise o desempenho das suas aulas.</p>
        </div>
        <div className="text-center py-20">
          <div className="w-20 h-20 rounded-full bg-violet-600/10 flex items-center justify-center mx-auto mb-4">
            <MdBarChart size={40} className="text-violet-400" />
          </div>
          <h2 className="text-lg font-semibold text-gray-200 mb-2">Em breve</h2>
          <p className="text-sm text-gray-400 max-w-sm mx-auto">
            Os relatórios de desempenho estarão disponíveis na próxima versão da plataforma.
          </p>
        </div>
      </div>
    </div>
